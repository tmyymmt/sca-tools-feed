...
セキュリティ／脆弱性スキャンツールのリリース情報を集約し、各ツールごとのまとめページのmarkdownを更新し、比較ページのmarkdownを更新し、フィードとして公開するリポジトリです。
...
https://tmyymmt.github.io/sca-tools-feed/ で GitHub Pages として公開されています。フィード一覧・各ツールまとめページ・比較ページを閲覧できます。

## 動作原理

- 以下のいずれかの方法で各markdownファイルとフィードファイルを更新する
